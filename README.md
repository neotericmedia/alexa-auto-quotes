# GI-Voice-Services
Voice enable API's for GI Services and FAQ. 
...
```
git clone https://sourcecode.ana.corp.aviva.com/projects/DIG/repos/gi-voice-services
```
- Install dependencies
```
cd gi-voice-services
npm install
```
...
mongod
```
- Make a copy of the `.env.example` file in the project root
